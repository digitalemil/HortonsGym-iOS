...
extern NSString        *dateString, *userstr, *serverstr, *server1,*server2, *servertotry, *servertried;
...
-(void) saveSettings {
    ...
    NSData *myData = [NSData dataWithBytes:buf length:1024*sizeof(char)];
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex {
    if (buttonIndex == 1 && alerttype== 1) {
        ...
        NSString *filePath = [documentsPath stringByAppendingPathComponent:@"hortonsgym.settings"];
        NSError *error;
